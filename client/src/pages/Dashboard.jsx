                    ...
                    {companyData && (
                        <div className='flex items-center gap-3'>
                            ...
                            <div className='relative group'>
                                <img className='w-8 h-8 border rounded-full object-cover' src={companyData.image} alt="" />
                                <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12'>
                                    <ul className='list-none m-0 p-2 bg-white rounded-md border text-sm min-w-[140px] shadow-lg'>
                                        <li onClick={() => navigate('/dashboard/profile')} className='py-1.5 px-2 cursor-pointer hover:bg-gray-50 border-b rounded-t-md'>Company Profile</li>
                                        <li onClick={logout} className='py-1.5 px-2 cursor-pointer hover:bg-gray-50 rounded-b-md text-red-600'>Logout</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div className='flex items-start'>
                ...
                <div className='inline-block min-h-screen border-r-2'>
                    <ul className='flex flex-col items-start pt-5 text-gray-800'>
                        ...
                        <NavLink className={({ isActive }) => ` flex items-center p-3 sm:px-6 gap-2 w-full hover:bg-gray-100 ${isActive && 'bg-blue-100 border-r-4 border-blue-500'}`} to={'/dashboard/profile'}>
